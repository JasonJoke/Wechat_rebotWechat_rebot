...
delta = future - now
# 企业微信机器人的webhook
send_url = "https://qyapi.weixin.qq.com/cgi-bin/webhook/send?key=31ad2796-51b2-4337-b7dd-51c46d80f090"
...
def send_msg_markdown():
    send_data = {
        "msgtype": "markdown",
        "markdown": {
            "content": "# 距2020年12月31日 Bug Free\n" +
                       "# **剩余<font color=\"warning\">{}</font>天** \n".format(delta.days) +
